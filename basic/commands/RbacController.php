...
class RbacController extends Controller
{
    public function actionInit()
    {
        ...
        //$substation  = $authManager->createPermission('substation-index');
        $padmin  = $authManager->createPermission('padmin');
        ...
        //$authManager->add($substation);
        $authManager->add($padmin);
        ...
        $authManager->addChild($admin, $padmin);
    }
}